              ...
              <div class="container">
                <div class="row">
                      ...
                      <table style="font-family: 'Baloo Paaji', cursive;">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <input type="number" name="contact" placeholder="0000000000">
                            </td>
                          </tr>
                          <tr>
                  ...
                  <div class="col-md-6" style="font-family: 'Baloo Paaji', cursive;">
                    ...
                    <br>
                    <br>
                    <button type="submit" class="btn btn-lg btn-success" style="height:50px; width:100px">Save</button>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <button type="submit" class="btn btn-lg btn-success" style="height:50px; width:100px">Cancel</button>
                  </div>
                </div>
              </div>
            </div>
