<html><head>
    ...
    <div class="section">
      ...
      <div class="section">
        <div class="container">
          <div class="col-md-7">
            <h3>Categories {Category name} Product Listings</h3>
          </div>
          <div class="col-md-5">
            <button type="submit" class="btn btn-lg" style="height:50px; width:200px; float:right" data-toggle="modal" data-target="#myModal1">Reassign all Products</button>
          </div>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" style="text-align: center;">Reassign all Products</h4>
                </div>
                <div class="modal-body" style="text-align:center;">
                  <p>Please select a category below to reassign all products to</p>
                  <div class="dropdown">Reassign to
                    <select>
                  ...
                  <div class="modal-footer">
                    <div style="display: block; margin: 0 auto; text-align:center;">
                      <button onclick="window.location.href='/#'" type="submit" class="btn btn-lg" style="height:50px; width:100px">Reassign</button>&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <table class="table" border="1">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>5000</td>
                    <td>
                      <a data-target="#myModal1" data-toggle="modal" href="#myModal1">Reassign</a>
                      <a href="#">Edit</a>&nbsp;
